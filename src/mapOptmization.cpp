...
public:
    ...
    void addOdomFactor()
    {
        if (cloudKeyPoses3D->points.empty())
        {
            ...
            noiseModel::Diagonal::shared_ptr priorNoise = noiseModel::Diagonal::Sigmas((Vector(6) << 0.01, 0.01, 0.01, 0.5, 0.5, 0.5).finished());
    ...
    void publishOdometry()
    {
        ...
        laserOdometryROS.child_frame_id = lidarFrame; // "odom_mapping";
        ...
        tf::StampedTransform trans_odom_to_lidar = tf::StampedTransform(t_odom_to_lidar, timeLaserInfoStamp, odometryFrame, lidarLink);
